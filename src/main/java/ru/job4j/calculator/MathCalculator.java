...
public class MathCalculator {
    ...
    public static double sumAndMultiplyAndDivisionAndDifference(double first, double second) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат расчета равен: " + sumAndMultiplyAndDivisionAndDifference(10, 20));
    }
}